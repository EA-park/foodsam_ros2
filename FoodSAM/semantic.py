...
from .mmcv_deprecated.utils import DictAction
import argparse
import json
import os
import numpy as np
...
parser.add_argument(
    "--SAM_checkpoint",
    type=str,
    default=base_path + "ckpts/sam_vit_h_4b8939.pth",
    help="The path to the SAM checkpoint to use for mask generation.",
)
parser.add_argument('--semantic_config', default=base_path + "configs/SETR_MLA_768x768_80k_base.py", help='test config file path of mmseg')
parser.add_argument('--semantic_checkpoint', default=base_path + "ckpts/SETR_MLA/iter_80000.pth", help='checkpoint file of mmseg')
parser.add_argument(
    "--model-type",
    type=str,
    default='vit_h',
...
parser.add_argument('--color_list_path', type=str, default=base_path + "FoodSAM/FoodSAM_tools/color_list.npy", help='the color used to draw for each label')

parser.add_argument(
    "--category_txt",
    default=base_path + "FoodSAM/FoodSAM_tools/category_id_files/foodseg103_category_id.txt", help='the category name of each label'
)
parser.add_argument(
    "--num_class",
